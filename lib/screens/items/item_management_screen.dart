...
class _ItemManagementScreenState extends State<ItemManagementScreen> {
  ...
  void _handleItemAction(String value, Item item, ItemsProvider itemsProvider) {
    switch (value) {
      ...
      case 'remove_barcode':
        ...
        break;
      case 'delete':
        _confirmDeleteItem(item, itemsProvider);
        break;
      case 'activate':
      case 'deactivate':
  ...
  void _confirmDeleteItem(Item item, ItemsProvider itemsProvider) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'This cannot be undone. All stock data will be removed. Transaction history is kept.',
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              Navigator.pop(context);
              final success = await itemsProvider.deleteItem(item.id);
              if (!mounted) return;
              if (success) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Failed to delete: ${itemsProvider.errorMessage}'),
                    backgroundColor: Colors.red,
                  ),
                );
              }
